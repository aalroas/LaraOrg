        ...
        if (!empty($Setting)) {
            ...
            if ($request->$formFileName != "") {
                ...
                if ($Setting->site_logo_ar != "") {
                       unlink('uploads/settings/' . $Setting->site_logo_ar);
                }
            ...
            if ($request->$formFileNameEn != "") {
                ...
                if ($Setting->site_logo_en != "") {
                   unlink('uploads/settings/' . $Setting->site_logo_en);
                }
            ...
            if ($request->$formFileNameTr != "") {
                ...
                if ($Setting->site_logo_tr != "") {
                   unlink('uploads/settings/' . $Setting->site_logo_tr);
                }
...
// icon icin
            ...
            if ($request->$formIconFileName != "") {
                // Delete a style_logo_en photo
                if ($Setting->site_icon_ar != "") {
                   unlink('uploads/settings/' . $Setting->site_icon_ar);
                }
            ...
            if ($request->$formIconFileNameEn != "") {
                // Delete a style_logo_en photo
                if ($Setting->site_icon_en != "") {
                   unlink('uploads/settings/' . $Setting->site_icon_en);
                }
            ...
            if ($request->$formIconFileNameTr != "") {
                // Delete a style_logo_en photo
                if ($Setting->site_icon_tr != "") {
                   unlink('uploads/settings/' . $Setting->site_icon_tr);
                }
