...
class UserController extends BaseBackendController
{
    ...
    public function create(ManageUserRequest $request, RoleRepository $roleRepository, PermissionRepository $permissionRepository)
    {
        ...
        return view('backend.auth.user.create',compact('sectors', 'fields'))
     ...
     *
     * @param  \App\Admin\Model\Auth\User  $user
     * @return \Illuminate\Http\Response
     */
    public function member_card($id)
    {
        $user = User::find($id);
        return view('backend.auth.user.member_card', compact('user'));
    }
    ...
    public function updatePersonalInfo(UpdateUserRequest $request, User $user)
    {
        $this->userRepository->updatePersonalInfo(
            $user,
            $request->only('full_name_ar', 'full_name_en', 'full_name_tr', 'position_ar', 'position_en', 'position_tr', 'is_board', 'phone', 'gender', 'country', 'email', 'profile_image','roles','permissions'),
