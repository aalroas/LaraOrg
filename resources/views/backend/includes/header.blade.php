            ...
            <div class="navbar-collapse" id="navbar-mobile">
                <div class="mr-auto float-left bookmark-wrapper d-flex align-items-center">
                    ...
                    <ul class="nav navbar-nav bookmark-icons">
                        ...
                        <li class="nav-item d-none d-lg-block"><a class="nav-link" href="{{ route('frontend.index') }}" data-toggle="tooltip"
...
<div class="dropdown-menu" aria-labelledby="dropdown-flag">
    @foreach(array_keys(config('locale.languages')) as $lang)
        ...
        <a class="dropdown-item" href="{{ '/lang/'.$lang }}" data-language="en"><i class="flag-icon flag-icon-us"></i>@lang('menus.language-picker.langs.'.$lang)</a>
        @endif
        @endforeach
</div>
</li>
 ...
 <li class="nav-item d-none d-lg-block"><a class="nav-link nav-link-expand"><i
                    ...
                    <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link"
                            ...
                            <div class="user-nav d-sm-flex d-none"><span
                                    class="user-name text-bold-600">{{ $logged_in_user->full_name }}</span><span
                                    class="user-status">Available</span></div><span><img class="round"
                                    src="{{ $logged_in_user->picture }}" alt="avatar"
...
<ul class="main-search-list-defaultlist d-none">
    ...
    <li class="auto-suggestion d-flex align-items-center cursor-pointer"><a
            ...
            <div class="d-flex align-items-center">
                <div class="avatar mr-50"><img src="{{ asset('backend/app-assets/images/portrait/small/avatar-s-8.jpg')}}" alt="png"
                        height="32"></div>
                <div class="search-data">
    ...
    <li class="auto-suggestion d-flex align-items-center cursor-pointer"><a
            class="d-flex align-items-center justify-content-between py-50 w-100" href="#">
            <div class="d-flex align-items-center">
                <div class="avatar mr-50"><img src="{{ asset('backend/app-assets/images/portrait/small/avatar-s-1.jpg')}}" alt="png"
                        height="32"></div>
                <div class="search-data">
    ...
    <li class="auto-suggestion d-flex align-items-center cursor-pointer"><a
            class="d-flex align-items-center justify-content-between py-50 w-100" href="#">
            <div class="d-flex align-items-center">
                <div class="avatar mr-50"><img src="{{ asset('backend/app-assets/images/portrait/small/avatar-s-14.jpg')}}" alt="png"
                        height="32"></div>
                <div class="search-data">
    ...
    <li class="auto-suggestion d-flex align-items-center cursor-pointer"><a
            class="d-flex align-items-center justify-content-between py-50 w-100" href="#">
            <div class="d-flex align-items-center">
                <div class="avatar mr-50"><img src="{{ asset('backend/app-assets/images/portrait/small/avatar-s-6.jpg')}}" alt="png"
                        height="32"></div>
                <div class="search-data">
