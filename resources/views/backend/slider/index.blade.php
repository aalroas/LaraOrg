                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href=""
                                                onclick="if(confirm('Are You sure you want to delete this')){slider.preventDefault();document.getElementById('delete-form-{{ $slider->id }}').submit();}else{slider.preventDefault();}">
                                                <i class="feather icon-delete"> </i></a>
                                            <form id="delete-form-{{ $slider->id }}" method="slider"
