                ...
                <div class="card-body">
                    ...
                    <div class="tab-content pt-1">
                        <div class="tab-pane active" id="home-testimonial" role="tabpanel"
                            ...
                            <input type="text" class="form-control" name="title_ar" value="{{ $testimonial->title_ar }}"
                                aria-required="true">
                            <h4 class="card-title">
                        ...
                        <div class="tab-pane" id="profile-testimonial" role="tabpanel" aria-labelledby="profile-tab-justified">
                            ...
                            <input type="text" class="form-control" name="title_en" value="{{   $testimonial->title_en }}"
                                aria-required="true">
                            <h4 class="card-title">
                                {{ trans('backend.text') }}</h4>
                        ...
                        <div class="tab-pane" id="messages-testimonial" role="tabpanel"
                            ...
                            <input type="text" class="form-control" name="title_tr" value="{{   $testimonial->title_tr }}"
                                aria-required="true">
                            <h4 class="card-title">
                                {{ trans('backend.text') }}</h4>
