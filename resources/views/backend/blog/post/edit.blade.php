...
<div class="col-12">
        ...
        <div class="card c_grid c_yellow">
            <div id="{{ $post_images->id }}" class="body text-center">
...
selectYears: 20
            ...
            <div class="row clealfix">
                <div class="col-sm-4">
                    <div class="card">
                        <div class="header">
                            <h2>{{ trans('backend.unit_news') }}</h2>
                        </div>
                <div class="body">
<select id="single-selection" name="type">
        <option @if ($post->type === 1 ) selected @endif value="1"> {{ trans('backend.media_and_marketing_unit') }} </option>
        <option @if ($post->type === 2 ) selected @endif value="2"> {{ trans('backend.investment_and_projects_unit') }} </option>
        <option @if ($post->type === 3 ) selected @endif value="3"> {{ trans('backend.membership_and_resource_development_unit') }} </option>
        <option @if ($post->type === 4 ) selected @endif value="4"> {{ trans('backend.relationship_unit') }} </option>
        <option @if ($post->type === 5 ) selected @endif value="5"> {{ trans('backend.training_unit') }} </option>
    </select>
