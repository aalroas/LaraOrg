...
@section('title', GeneralSiteSettings('site_title') . ' | ' . $bylaws->g_title)
                                ...
                                <article class="post  mb-30">
                                    ...
                                    <div class="entry-content p-20 pr-10">
                                        <div class="entry-meta media mt-0 no-bg no-border">
                                            <div class="media-body pl-15">
                                                <div class="event-content pull-left flip">
                                                <a class="btn btn-gray mt-10" href="{{asset('uploads/static')}}/{{$bylaws->g_pdf}}"><i class="fa fa-file-pdf-o pr-5"></i> {{ trans('frontend.download') }} :   {{ $bylaws->g_title }} </a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
