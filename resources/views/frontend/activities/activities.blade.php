    ...
    <section class="inner-header divider parallax layer-overlay overlay-dark-5" >
      <div class="container pt-10 pb-10">
        ...
        <div class="section-content pt-10">
          <div class="row">
            <div class="col-md-12">
              <h3 class="title text-white">{{ trans('frontend.activities') }}</h3>
            </div>
          </div>
        </div>
      </div>
              ...
              <div class="col-md-12">
                <div class="row list-dashed">
                    ...
                    <div class="col-md-4 entry-header">
                      ...
                      <img src="{{asset('uploads/activities/')}}/{{$activity->f_image}}" alt="{{$activity->title}}" class="img-responsive img-fullwidth">
                      </div>
                    </div>
                    <div class="col-md-8 entry-content p-20 pr-10">
                      <div class="entry-meta media mt-0 no-bg no-border">
                        ...
                        <div class="media-body pl-15">
                          ...
                          <h4 class="entry-title text-white text-uppercase m-0 mt-5"><a href="{{route('frontend.activity',$activity->slug)}}">{{$activity->title}}</a></h4>
...
<span class="mb-10 text-gray-darkgray mr-10 font-13">{{ trans('frontend.activity_type') }} :
    ...
    @endforeach
                    ...
                    <p  style="    text-align: justify;" class="mt-10">{!! Str::words($activity->text,30,'...')!!}</p>
                      <a href="{{route('frontend.activity',$activity->slug)}}" class="btn-read-more">{{ trans('frontend.read_more') }}</a>
