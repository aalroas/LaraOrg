                                    ...
                                    <a class="mr-2 my-15" href="#">
                                        <div class="form-group">
                                            <input type="file" name="company_logo" class="dropify"
                                                data-default-file="{{asset('storage')}}/{{$logged_in_user->company_logo}}"
                                                data-allowed-file-extensions="png jpg jpeg">
...
<div class="form-group">
    <div class="controls">
        ...
        <input type="text" name="sicil_no" class="form-control" placeholder="{{ trans('frontend.sicil_no') }}"
            value="{{ $logged_in_user->sicil_no}}" required data-validation-required-message="{{ trans('frontend.sicil_no') }}">
    </div>
</div>
                            ...
                            <div class="col-12 col-sm-6">
                                <h5 class="mb-1 mt-2 mt-sm-0"><i class="feather icon-map-pin mr-25"></i>{{ trans('backend.address_info') }}</h5>
                            ...
                            <div class="row">
                                <div class="col-12 col-sm-6">
                                    ...
                                    <fieldset>
                                        ...
                                        <label>{{ trans('backend.instagram') }}</label>
                                        <div class="input-group mb-75">
                                            <div class="input-group-prepend">
                                ...
                                <div class="col-12 col-sm-6">
                                    <label>{{ trans('backend.linkedin') }}</label>
                                    <div class="input-group mb-75">
                                        <div class="input-group-prepend">
