                    ...
                    <div class="card bg-analytics text-white">
                        <div class="card-content">
                            <div class="card-body text-center">
                                <img src="{{ asset('backend/app-assets/images/elements/decore-lsadsaeft.png')}}" class="img-left" alt="
                    card-img-left">
                                <img src="{{ asset('backend/app-assets/images/elements/decodasdre-right.png')}}" class="img-right" alt="
                    card-img-right">
                                ...
                                <div class="text-center">
                                    ...
                                    <p class="m-auto w-75">{!! __('strings.backend.welcome') !!}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <ul class="activity-timeline timeline-left list-unstyled">
                                    <li>
                                        ...
                                        <div class="timeline-info">
                                            ...
                                            <span class="font-small-3">Bonbon macaroon jelly beans gummi bears jelly lollipop
                                                apple</span>
                                        </div>
                                                ...
                                                <ul class="list-unstyled users-list m-0  d-flex align-items-center">
                                                    <li data-toggle="tooltip" data-popup="tooltip-custom"
                                                        ...
                                                        <img class="media-object rounded-circle"
                                                            src="{{ asset('backend/app-assets/images/portrait/small/avatar-s-5.jpg')}}"
                                                    ...
                                                    <li data-toggle="tooltip" data-popup="tooltip-custom"
                                                        ...
                                                        class="avatar pull-up">
                                                        <img class="media-object rounded-circle"
                                                            src="{{ asset('backend/app-assets/images/portrait/small/avatar-s-10.jpg')}}"
                                                            alt="Avatar" height="30" width="30">
                                                    </li>
                                                    <li data-toggle="tooltip" data-popup="tooltip-custom"
                                            ...
                                            <td class="p-1">
                                                <ul class="list-unstyled users-list m-0  d-flex align-items-center">
                                                    ...
                                                    <li data-toggle="tooltip" data-popup="tooltip-custom"
                                                        ...
                                                        class="avatar pull-up">
                                                        <img class="media-object rounded-circle"
                                                            src="{{ asset('backend/app-assets/images/portrait/small/avatar-s-2.jpg')}}"
                                                            alt="Avatar" height="30" width="30">
                                                    </li>
                                                    <li data-toggle="tooltip" data-popup="tooltip-custom"
                                            ...
                                            <td class="p-1">
                                                <ul class="list-unstyled users-list m-0  d-flex align-items-center">
                                                    ...
                                                    <li data-toggle="tooltip" data-popup="tooltip-custom"
                                                        ...
                                                        class="avatar pull-up">
                                                        <img class="media-object rounded-circle"
                                                            src="{{ asset('backend/app-assets/images/portrait/small/avatar-s-9.jpg')}}"
                                                            alt="Avatar" height="30" width="30">
                                                    </li>
                                                </ul>
                                            </td>
