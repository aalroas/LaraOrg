...
Route::group([
    ...
    Route::group(['namespace' => 'User'], function () {
        ...
        Route::get('user/member_card/{user_id}', 'UserController@member_card')->name('user.member_card');
        ...
        Route::group(['prefix' => 'user/{user}'], function () {
            ...
            Route::patch('user/updateCompanyInfo', [UserController::class, 'updateCompanyInfo'])->name('user.updateCompanyInfo');
            Route::patch('user/updateContactInfo', [UserController::class, 'updateContactInfo'])->name('user.updateContactInfo');
            Route::patch('user/updatePersonalInfo', [UserController::class, 'updatePersonalInfo'])->name('user.updatePersonalInfo');
