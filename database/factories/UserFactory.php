...
$factory->define(User::class, function (Generator $faker) {
    return [
        ...
        'full_name_tr' => $faker->name,

        'phone' => $faker->PhoneNumber,

        'year_founded' => $faker->dateTimeBetween('-20 days', 'now'),

        'main_location_ar' => $faker->address,
        'main_address_ar' => $faker->address,

        'company_name_ar' => $faker->company,
        'company_name_en' => $faker->company,
        'company_name_tr' => $faker->company,
