...
return [
    ...
    */
    ...
    'headline'      => 'Welcome to IBDA Forum',
    ...
    */
    ...
    'user' => [
        ...
        'database_field_with_user_name' => 'full_name_ar',
        'relative_url_to_profile'       => env('APP_URL') . 'about/members/',
        'relative_url_to_image_assets'  => env('APP_URL') . 'storage/', //asset('')
        'avatar_image_database_field'   => 'profile_image',
    ],
